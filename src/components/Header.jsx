      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 group cursor-pointer">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-black dark:bg-white flex items-center justify-center group-hover:scale-105 transition-transform">
              <span className="text-white dark:text-black text-xs font-medium">P</span>
            </div>
            <div className="text-lg sm:text-xl font-light tracking-tight text-black dark:text-white">
              Portfolio
            </div>
          </div>
          ...
          <div className="flex md:hidden items-center gap-3">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full bg-gray-700 dark:bg-gray-700 hover:bg-gray-600 dark:hover:bg-white/30 transition-all border border-black/10 dark:border-white/30"
              aria-label="Toggle theme"
            >
              {isDarkMode ? (
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-3 border-t border-black/5 dark:border-white/5 pt-4">
            <a 
              href="#profile" 
              onClick={() => setIsMenuOpen(false)}
              className="block text-sm font-light text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors py-2"
            >
              Home
            </a>
            <a 
